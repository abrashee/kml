...
public class SecurityConfig {
  ...
  public SecurityFilterChain securityFilterChain(
    ...
    http.authorizeHttpRequests(auth -> {
      ...
      auth
          .requestMatchers(HttpMethod.GET, "/api/v1/shipments/service-info").authenticated()
          .requestMatchers(HttpMethod.GET, "/api/v1/shipments/**").hasAnyRole("ADMIN", "MANAGER", "WORKER", "CUSTOMER")
          .requestMatchers(HttpMethod.POST, "/api/v1/shipments").hasAnyRole("ADMIN", "MANAGER", "WORKER")
          .requestMatchers(HttpMethod.PATCH, "/api/v1/shipments/*/status/**").hasAnyRole("ADMIN", "MANAGER", "WORKER")
