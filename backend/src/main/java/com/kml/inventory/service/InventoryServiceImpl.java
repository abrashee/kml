...
import com.kml.inventory.mapper.InventoryMapper;
...
public class InventoryServiceImpl implements InventoryService {
  ...
  @Override
  @Transactional(readOnly = true)
  public Page<InventoryItemResponseDto> getInventoriesPage(String search, Pageable pageable) {
    Page<InventoryItem> page;
    if (search != null && !search.isBlank()) {
      page = inventoryRepository
          .findBySkuContainingIgnoreCaseOrNameContainingIgnoreCase(search, search, pageable);
    } else {
